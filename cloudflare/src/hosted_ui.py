...
async function initializeHosted(){
  ...
  account.append(element('p',state.member.email,'muted'),button('Connect an agent',openConnections));
...
async function openConnections(){
  ...
  dialog.showModal();try{await list();}catch(e){dialog.querySelector('#key-error').textContent=e.message;}
}
'''
